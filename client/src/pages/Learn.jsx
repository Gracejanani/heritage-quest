...
export default function Learn() {
  ...
  const filtered = useMemo(
    () =>
      learningTopics.filter((t) =>
        `${t.title} ${t.description} ${t.tag} ${t.learn.join(" ")}`
          .toLowerCase()
        ...
        <div className="container-app grid items-center gap-8 lg:grid-cols-[1fr_.75fr]">
          <div>
            ...
            <h1 className="mt-4 font-display text-5xl font-extrabold text-heritage-brown sm:text-6xl">
              Explore. Learn. <span className="text-heritage-green">Grow.</span>
            </h1>
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600">
              Discover India’s history, culture and heritage through 12 focused
              chapters, each connected to a 10-question medium-and-advanced
              quiz.
            </p>
            <SearchBar
              value={query}
              onChange={setQuery}
              placeholder="Search chapters, dynasties, monuments, culture..."
          ...
          <div className="relative hidden lg:block">
            <img
              ...
              alt="Young explorer learning about Indian heritage"
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 inline-flex items-center gap-1.5 rounded-full bg-amber-50 px-3 py-1 text-xs font-bold text-amber-800">
                    ...
                    {topic.questionCount} medium + advanced questions
                  </div>
          ...
          <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-white/65">
                Build chronology and context with evidence-based questions
